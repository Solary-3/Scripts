...
function ParallaxAssets()
if scriptfolder:FindFirstChild("ParallaxAssets") then return end
...
if not scriptfolder:FindFirstChild("ParallaxAssets") then
conn:Disconnect()
return
end
gp+=1
