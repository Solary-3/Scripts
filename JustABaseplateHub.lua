...
print("\n\n\n-- If you ever see a person named White Hat or sfsue6747, for the love of god, hes a freak, he is a complete airhead and every argument you say towards him aint affecting that bitch, he always evade eveda everything by using David Baszucki strategty, some members call a PDF like that, he acts so freaky near my friend dummy guy before he even renamed himself like that and yet still acts the same way ane never changed his behavior, i also know his age(hes 19) and the friend that hes doig that strange behavior is 12, he even calls himself a trustworthy dev😭. He used a paid inappropriate script on a kids game over 20x. So if you ever see him, stay away from that freak.")
...
local Hydrogen  = ExecutorsTab:CreateButton({
   Name = "Hydrogen",
...
Button8 = HatsTab:CreateButton({
   ...
   Callback = function() 
   Chat("-gh 5316479641,5316539421,5268602207,5316549755 131385506535381 85392395166623 129462518582032 138364679836274 12850150835 106249329428811")
