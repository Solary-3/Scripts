...
AddModule(function()
    ...
    m.Init = function(figure)
        SetOverrideDanceMusic(AssetGetContentId("Heart Of Glass.mp3"),"Heart Of Glass",1,nil,1.12)
...
AddModule(function()
    ...
    local hum = figure:FindFirstChild("Humanoid")
		...
		RootJoint.Transform=Lerp(RootJoint.Transform,cfMul(cf(-0.5*scale*cos((sine*15)+0)+0,0.5*scale*sin((sine*15)+0),-.5*scale),angles(0,-0.17453292519943295+0,0)),deltaTime)
		LeftHip.Transform=cfMul(cf(0,.25*scale,.25*scale),angles(0.17453292519943295,0,0))
		RightHip.Transform=cfMul(cf(0+0,.5*scale,.25*scale),angles(-0.8726646259971648,0,0))
...
AddModule(function()
	...
	m.Assets      = {
	  "Irisout.anim@https://github.com/valttasar/Valttas-Port-Content/raw/refs/heads/main/Iris%20Out/Irisout.anim",
	  "Irisout.mp3@https://github.com/valttasar/Valttas-Port-Content/raw/refs/heads/main/Iris%20Out/Irisout.mp3"
	}
...
AddModule(function()
	...
	m.Assets      = {"Spoken For.lua@https://raw.githubusercontent.com/Solary-3/Scripts/refs/heads/main/Spoken For.lua",
	  "Spokenfor1.mp3@https://github.com/valttasar/Valttas-Port-Content/raw/refs/heads/main/Spoken%20For/Spokenfor.mp3",
	  "Spokenfor.rbxm@https://github.com/valttasar/Valttas-Port-Content/raw/refs/heads/main/Spoken%20For/Spokenfor.rbxm"
	}
	...
	m.Init = function(figure)
		SetOverrideDanceMusic(AssetGetContentId("Spokenfor1.mp3"), "Spoken For", 0.8, NumberRange.new(0, 999))

		start        = os.clock()
		animator     = AnimLib.Animator.new()
		animator.rig = figure
		animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("Spoken For.lua"))
		animator.looped = true
		animator.speed  = 1
...
AddModule(function()
    ...
    m.Description = " "
    m.Assets = {
      "Rabbit Pole.lua@https://github.com/Solary-3/Scripts/raw/refs/heads/main/Rabbit Pole.lua",
      "Rabbit Pole.mp3@https://github.com/Solary-3/Scripts/raw/refs/heads/Audios-1/Rabbit Pole.mp3?raw=true"
    }
    ...
    m.Init = function(figure)
        SetOverrideDanceMusic(AssetGetContentId("Rabbit Pole.mp3"))

        start           = os.clock()
        animator        = AnimLib.Animator.new()
        animator.rig    = figure
        animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("Rabbit Pole.lua"))
        animator.looped = true
        animator.speed  = 1
    end
...
AddModule(function()
    ...
    m.Description = " "
    m.Assets = {
      "Mibombo.lua@https://github.com/Solary-3/Scripts/raw/refs/heads/main/Mibombo.lua",
      "Mibombo.mp3@https://github.com/Solary-3/Scripts/raw/refs/heads/Audios-1/Mibombo.mp3?raw=true"
    }
    ...
    m.Init = function(figure)
        SetOverrideDanceMusic(AssetGetContentId("Mibombo.mp3"))

        start           = os.clock()
        animator        = AnimLib.Animator.new()
        animator.rig    = figure
        animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("Mibombo.lua"))
        animator.looped = true
        animator.speed  = 1
    end
...
AddModule(function()
    ...
    m.ModuleType  = "DANCE"
    m.Name        = "Yuji Edit"
    m.Description = "Ts so tuff"
    m.Assets = {
      "Yuji Edit.lua@https://github.com/Solary-3/Scripts/raw/refs/heads/main/Yuji Edit.lua",
      "Yuji Edit.mp3@https://github.com/Solary-3/Scripts/raw/refs/heads/Audios-1/Yuji Edit.mp3?raw=true"
    }
    ...
    m.Init = function(figure)
        SetOverrideDanceMusic(AssetGetContentId("Yuji Edit.mp3"))

        start           = os.clock()
        animator        = AnimLib.Animator.new()
        animator.rig    = figure
        animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("Yuji Edit.lua"))
        animator.looped = true
        animator.speed  = 1
    end
...
AddModule(function()
	...
	m.Assets      = {
	  "Competent.anim@https://github.com/valttasar/Valttas-Port-Content/raw/refs/heads/main/Competent/Competent.anim",
	  "Competent.mp3@https://github.com/valttasar/Valttas-Port-Content/raw/refs/heads/main/Competent/Competent.mp3"
	}
...
AddModule(function()
    ...
    m.ModuleType  = "DANCE"
    m.Name        = "Baldi bounce"
    m.Description = "Baldi jumping around :D"
    m.Assets = {
      "BaldiBounce.anim@https://github.com/Solary-3/Scripts/raw/refs/heads/main/BaldiBounce.anim",
      "Baldi.mp3@https://github.com/Solary-3/Scripts/raw/refs/heads/Audios-1/Baldi.mp3?raw=true"
    ...
    local start    = 0
    m.Init = function(figure)
        SetOverrideDanceMusic(AssetGetContentId("Baldi.mp3"), "Baldi", 0.8, NumberRange.new(0, 45.5))
        start           = os.clock()
        animator        = AnimLib.Animator.new()
        animator.rig    = figure
...
table.insert(modules,function()
    ...
    m.Description = " "
    m.Assets = {
      "Mambo.anim@https://github.com/Solary-3/Scripts/raw/refs/heads/main/Mambo.anim",
      "Mambo.mp3@https://github.com/Solary-3/Scripts/raw/refs/heads/Audios-1/Mambo.mp3?raw=true"
    ...
    local start    = 0
    m.Init = function(figure)
        SetOverrideDanceMusic(AssetGetContentId("Mambo.mp3"))
        start           = os.clock()
        animator        = AnimLib.Animator.new()
        animator.rig    = figure
...
table.insert(modules,function()
    ...
    m.Description = " "
    m.Assets = {
      "Decadent Life.anim@https://github.com/Solary-3/Scripts/raw/refs/heads/main/Decadent Life.anim",
      "Decadent Life.mp3@https://github.com/Solary-3/Scripts/raw/refs/heads/Audios-1/Decadent Life.mp3?raw=true"
    ...
    local start    = 0
    m.Init = function(figure)
        SetOverrideDanceMusic(AssetGetContentId("Decadent Life.mp3"))
        start           = os.clock()
        animator        = AnimLib.Animator.new()
        animator.rig    = figure
...
table.insert(modules,function()
    ...
    m.Description = " "
    m.Assets = {
      "Chika Edit.anim@https://github.com/Solary-3/Scripts/raw/refs/heads/main/Chika Edit.anim",
      "Chika Edit.mp3@https://github.com/Solary-3/Scripts/raw/refs/heads/Audios-1/Chika Edit.mp3?raw=true"
    ...
    local start    = 0
    m.Init = function(figure)
        SetOverrideDanceMusic(AssetGetContentId("Chika Edit.mp3"))
        start           = os.clock()
        animator        = AnimLib.Animator.new()
        animator.rig    = figure
...
table.insert(modules,function()
    ...
    m.Description = " "
    m.Assets = {
      "Split Dance.anim@https://github.com/Solary-3/Scripts/raw/refs/heads/main/Split Dance.anim",
      "Split Dance.mp3@https://github.com/Solary-3/Scripts/raw/refs/heads/Audios-1/Split Dance.mp3?raw=true"
    ...
    local start    = 0
    m.Init = function(figure)
        SetOverrideDanceMusic(AssetGetContentId("Split Dance.mp3"),"Split Dance",1,nil,1.25)
        start           = os.clock()
        animator        = AnimLib.Animator.new()
        animator.rig    = figure
        animator.track  = AnimLib.Track.fromfile(AssetGetPathFromFilename("Split Dance.anim"))
        animator.looped = true
        animator.speed  = 1
    end
    m.Update = function(dt, figure)
