...
RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1,-0.5,-0.75),angles(0,1.5707963267948966,-0.3490658503988659)),deltaTime)  RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1,0.75,-1),angles(-0.3490658503988659,0,-1.9198621771937625)),deltaTime)  RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0+mrandom(-25,25),15+mrandom(-2.5,2.5),0),angles(-1.2217304763960306+mrandom(-25,25),0+mrandom(-25,25),3.141592653589793+mrandom(-25,25))),deltaTime)  LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1,0.5,-1),angles(-0.6981317007977318,0,2.0943951023931953)),deltaTime)  Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1,0),angles(-2.0943951023931953,0,3.141592653589793)),deltaTime)  LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-1,-0.5,-1.15),angles(0,-1.5707963267948966,0.5235987755982988)),deltaTime)  
