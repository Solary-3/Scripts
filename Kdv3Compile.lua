...
wait(5)
notif("I know it hurts losing me, but this is your fault, not me")
wait(5)
notif("Hopefully youll feel the  pain that im having right now")
wait(5)
notif("So yeah... see you around and hope youll get around with this")
wait(2)
player:Kick('"The adventure isnt over yet, there still someone out there that will make you smile"\n\t-Love from Theo/Sage')
else
...
wait(1)
notify('pls click "click me" first for updates!!!', 10)
wait(.75)
