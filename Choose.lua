...
wait(1)
notify("and if you wanna use this in a different game")
wait(1)
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Solary-3/Scripts/refs/heads/main/WhatIsThisScript.lua"))()
end)
