...
print("\n\n\n-- If you ever see a person named White Hat, for the love of god, hes a freak and used a doll script, has a history of beind6a pdf and some of his members call him like that, he acts so freaky near my friend dummy guy before he even renamed himself like that and yet still acts the same way ane never changed his behavio, i also know his age(hes 19) and the friend that hes doig that strange behavior is 12. He used a paid inappropriate script on a kids game over 20x. So if you ever see him, stay away from that freak.")
