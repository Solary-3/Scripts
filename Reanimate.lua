...
local PermanentDeath = Global.RayfieldConfig["Permanent Death"]  or false
...
local KeepHairWelds = Global.RayfieldConfig["Keep Hats On Head"] or false
...
local AntiVoid = Global.RayfieldConfig["Anti Void"] or false
