...
if test_ModeAhax == true then
	print("********************************************************************************")
	warn("**** Hydrogen Android Undergoes Maintenance, It will be back in a few minutes **** ")
	print("********************************************************************************")
else
--// Instances
local function EvonNotification(messages)
	game.StarterGui:SetCore("SendNotification", {
		...
		Icon = "rbxassetid://16831669876"; -- the image if u want. 
...
local function EvonCheckKey(ClientKey)
	...
	elseif Key_Disabled then
		EvonNotification("Welcome to Hydrogen Android")
		return true
...
if _isfolder("Hydrogen") == false then
	_makefolder("Hydrogen");
end
if _isfile("Hydro/settings.json") then
...
local function loadMainUI()
	local toggleMain = create("TextButton", { 
		...
		create("ImageLabel", { 
			...
			BackgroundColor3 = Color3.fromHex("ffffff"), 
			BackgroundTransparency = 1, 
			Image = "rbxassetid://16831669876", 
			ImageColor3 = Color3.fromRGB(250, 252, 250),
			Name = "icon", 
			Position = UDim2.new(0.5, 0, 0.5, 0), 
