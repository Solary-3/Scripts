...
local TE = Anim(UUUUUU,  77200035851748)
local TR = Anim(UUUUUU, 112924713565732)
local TT = Anim(UUUUUU, 124685849885175)
   TQ:Play()
task.wait(.45)
TQ:Stop()
task.wait(.05)
