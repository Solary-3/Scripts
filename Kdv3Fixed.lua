...
function Reanimate() 
local reaninated=nil
for _, v in game.Workspace.Terrain:GetChildren() do 
if v:FindFirstChild("ReanimatedRig") then 
reaninated=true
else 
reaninated=false
end
...
if reaninated then notify("Reanimated") return end
KryptonConfiguration = {
WaitTime = 0,
FakeRigScale = 1,
DestroyHeightOffset = 70,
TeleportOffsetRadius = 5,
RefitHatCount = 1,

RigName = "ReanimatedRig",
...
Hats = {
["Right Arm"] = {
{Texture = "17269487469", Mesh = "17269487439", Name = "Accessory (Middle Void Wall)", Offset = CFrame.Angles(0, 0, math.rad(90))},
{Texture = " ", Mesh = " ", Name = "Right Arm", Offset = CFrame.Angles(0, 0, math.rad(90))},
{Texture = "136752500636691", Mesh = "125405780718494", Name = "Accessory (RArm)", Offset = CFrame.new(0,0,0) * CFrame.Angles(math.rad(0), 0, math.rad(-90))},
{Texture = "135650240593878", Mesh = "137702817952968", Name = "Accessory (RArmNoob)", Offset = CFrame.new(0,0,0) * CFrame.Angles(math.rad(0), 0, math.rad(-90))},
},
...
{Texture = "17269487469", Mesh = "17269487439", Name = "Accessory (Left Void Wall)", Offset = CFrame.Angles(0, 0, math.rad(90))},
{Texture = "135650240593878", Mesh = "137702817952968", Name = "Accessory (LArmNoob)", Offset = CFrame.new(0,0,0) * CFrame.Angles(math.rad(0), 0, math.rad(-90))},
},

["Right Leg"] = {
{Texture = "17269487469", Mesh = "17269487439", Name = "Accessory (Right Void Wall)", Offset = CFrame.Angles(0, 0, math.rad(90))},
...
{Texture = "73798034827573", Mesh = "137702817952968", Name = "Accessory (RLegNoob)", Offset = CFrame.new(0,0,0) * CFrame.Angles(math.rad(0), 0, math.rad(-90))},
},

["Left Leg"] = {
{Texture = "136752500636691", Mesh = "125405780718494", Name = "Accessory (LLeg)", Offset = CFrame.Angles(0, 0, math.rad(90))},
{Texture = "17269487469", Mesh = "17269487439", Name = "Accessory (Void Backpack)", Offset = CFrame.Angles(0, 0, math.rad(90))},
...
{Texture = "73798034827573", Mesh = "137702817952968", Name = "Accessory (LLegNoob)", Offset = CFrame.new(0,0,0) * CFrame.Angles(math.rad(0), 0, math.rad(-90))},
},

["Torso"] = {
{Texture = "125975972015302", Mesh = "126825022897778", Name = "Accessory (TorsoNoob)", Offset = CFrame.identity},
{Texture = "17269636558", Mesh = "17269636541", Name = "Accessory (Huge Void Backpack)", Offset = CFrame.identity},
...
REANIMATE.MouseButton1Click:Connect(Reanimate)
...
local gk
if game.Workspace.Terrain:FindFirstChild("ReanimatedRig") then
...
local walking = false
local idle = false
local char=game.Workspace.Terrain:FindFirstChild("ReanimatedRig")
...
if not workspace.Terrain.ReanimatedRig then 
local tweenInfo = TweenInfo.new(1.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
...
sound69:Stop()
stopanim()
game:GetService("CoreGui").VISgui:Destroy()
UPDATE:Disconnect()
UPDATE=nil
end
pcall(function()
if char:FindFirstChild("Accessory (EvilVoidHeadBackpack)") then
guji=char["Accessory (EvilVoidHeadBackpack)"].Handle
guji:BreakJoints()
local root=char["Head"]
local forward = root.CFrame.LookVector
local up = Vector3.new(0, 0, 0)
local front = CFrame.lookAt(root.Position,root.Position + forward,up)
local Offset = CFrame.new(0,root.Position.Y-9,0)
local tilt = CFrame.Angles(math.rad(-40),0,math.rad(0))
--local rotation = CFrame.Angles(0, rad(upd/2.5+sound.PlaybackLoudness/100), 0)
guji.AssemblyLinearVelocity=Vector3.new(0,25.01,0)
guji.CFrame=guji.CFrame:Lerp(front*Offset*tilt,1)
guji.Orientation=Vector3.new(char.Head.Orientation.X*-1,char.Head.Orientation.Y+180,char.Head.Orientation.Z)
end
end)
sine = sine + change
...
tween:Play()
pcall(function()
workspace.Terrarin.ReanimatedRig.Humanoid.Health=0
workspace.Terrarin.ReanimatedRig:BreakJoints()
end)
end


Stop1.MouseButton1Click:Connect(StopScript)
Run1.MouseButton1Click:Connect(MainScript)