...
notify("If you hate the new UI choose legacy")
wait(1)
notify("Legacy is deprecated and never will be updated")
...
notify("Chosen Legacy ")
loadstring(game:HttpGet("https://raw.githubusercontent.com/Solary-3/Scripts/refs/heads/main/Legacy.lua"))()
end)
