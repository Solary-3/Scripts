...
THIS SCRIPT BELOW IS OWNED BY GELATEK, I ONLY RENAMED SOME OF THE FUNCTIONS IN IT
...
local function AlignPart(Part0, Part1, Position, Orientation)
	Part0:BreakJoints()
...
local function PlayAnimation(ID,AudioPath)
	if game:FindFirstChildOfClass("TestService"):FindFirstChild("ScriptCheck") then
		StopScript()
	end
