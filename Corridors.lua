...
if scriptfolder:FindFirstChild("CorridorsAssets") then return end

local foldah=i("Folder",scriptfolder)
foldah.Name="CorridorsAssets"
...
if not scriptfolder:FindFirstChild("CorridorsAssets") then 
h:Disconnect()
...
repeat CorridorAssets() task.wait() until not scriptfolder:FindFirstChild("CorridorsAssets") 