...
local idleanim = game:GetObjects("rbxassetid://100592991677582")[1]
...
local sprintanim = is:LoadLocalAsset("rbxassetid://84471010390929")
       ...
       repeat task.wait() until isfile(id)
        ...
        return s.SoundId
           ...
           if loopsplaying>0 then 
            ...
            sound69.SoundId = customasset("Dances/Abyssal.mp3")
            sound69.Volume = .65
            else 
                sound69:Stop()
            end
...
elseif k == "f" then 
    if dancing == false then 
        stopanim()
  dancing = true
task.wait(.005)sound69.SoundId = customasset("Dances/Crazy.mp3")
       timeposcur = sound69.TimePosition 
sound69:Play() 
