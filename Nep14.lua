...
weaponweld.C1=clerp(weaponweld.C1,cf(0.5 + kan.PlaybackLoudness/350,0,-1.5)*angles(math.rad(0),math.rad(0),math.rad(190 +kan.PlaybackLoudness/10+sine/20*1.15)),.3)
end
end
